 ...
 * @since 1.0.0
 */
class Visualizer_Render_Sidebar_Gauge extends Visualizer_Render_Sidebar {
	...
	protected function _renderGreenColorSettings() {
		echo '<li class="group">';
			echo '<h3 class="group-title">', esc_html__( 'Green Color', Visualizer_Plugin::NAME ), '</h3>';
			echo '<ul class="group-content">';
				echo '<li>';
					echo '<div class="section-items open">';
						echo '<div class="section-description visible section-item">';
							esc_html_e( 'Configure the green section of the gauge chart.', Visualizer_Plugin::NAME );
						echo '</div>';
	...
	protected function _renderYellowColorSettings() {
		echo '<li class="group">';
			echo '<h3 class="group-title">', esc_html__( 'Yellow Color', Visualizer_Plugin::NAME ), '</h3>';
			echo '<ul class="group-content">';
				echo '<li>';
					echo '<div class="section-items open">';
						echo '<div class="section-description visible section-item">';
							esc_html_e( 'Configure the yellow section of the gauge chart.', Visualizer_Plugin::NAME );
						echo '</div>';
	...
	protected function _renderRedColorSettings() {
		echo '<li class="group">';
			echo '<h3 class="group-title">', esc_html__( 'Red Color', Visualizer_Plugin::NAME ), '</h3>';
			echo '<ul class="group-content">';
				echo '<li>';
					echo '<div class="section-items open">';
						echo '<div class="section-description visible section-item">';
							esc_html_e( 'Configure the red section of the gauge chart.', Visualizer_Plugin::NAME );
						echo '</div>';
