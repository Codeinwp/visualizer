...
class Visualizer_Render_Page_Types extends Visualizer_Render_Page {
	...
	protected function _renderToolbar() {
		...
		if ( ! empty( $libraries ) ) {
			?>
		<select name="chart-library" class="viz-select-library<?php echo ! Visualizer_Module_Admin::proFeaturesLocked() && ! defined( 'TI_CYPRESS_TESTING' ) ? ' viz-hide-library' : ''; ?>" data-type-vs-library="<?php echo esc_attr( json_encode( $type_vs_library ) ); ?>">
			<?php
